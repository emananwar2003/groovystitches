...
const Washing = () => {
  return (
    <div className=" bg-orange-700 px-5 py-5 gap-1 flex flex-col justify-center align-middle sm:flex-row sm:justify-evenly sm:align-middle md:flex-row md:justify-evenly md:align-middle lg:flex-row lg:justify-evenly lg:gap-2">

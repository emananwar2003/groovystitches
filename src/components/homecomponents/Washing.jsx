...
const Washing = () => {
    return (
        <div className=" bg-[#f9Af46] px-5 py-5 gap-1 flex flex-col justify-center align-middle sm:flex-row sm:justify-evenly sm:align-middle md:flex-row md:justify-evenly md:align-middle lg:flex-row lg:justify-evenly lg:gap-2">
            ...
            <div className="flex flex-col sm:w-1/3  text-center  items-center gap-2">
                ...
                <span className=" text-white ">Our prducts are customizable to your liking all you have to do is screenshot the product that you like and contact us through our instgram page @groovystitches</span>
            </div>
